...
{
    // Linking entity between Users and Roles (many-to-many or user-to-primary role)
    ...
    // Enum retaining the role types introduced in the other branch for backward compatibility
