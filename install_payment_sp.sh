...
# This script executes SQL commands to create payment-related stored procedures

echo "Creating payment stored procedures..."
...
run_sql() {
    ...
    # Use osql or sqlcmd
    sqlcmd -S "$SQL_SERVER" -d "$DATABASE" -Q "$sql" -E
}

# Create usp_GetOrderPaymentInfo
echo "Creating usp_GetOrderPaymentInfo..."
run_sql "
...
# Add other payment-related stored procedures here

echo "Payment stored procedures created successfully!"